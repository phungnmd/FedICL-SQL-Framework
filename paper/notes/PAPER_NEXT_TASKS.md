...
| 1 | **P1.5 FedProx-LoRA** | Kiểm tra FedLS có còn lợi thế khi so với optimizer FL mạnh hơn FedAvg. | GPU smoke, sau đó một production run | P1.5a GPU-ready; 334 tests pass |
