...
| 1 | **P1.5 FedProx-LoRA** | Kiểm tra FedLS có còn lợi thế khi so với optimizer FL mạnh hơn FedAvg. | GPU T3 training, sau đó T3-only eval | P1.5a-R pass; P1.5b GPU-ready |
...
P1.8a đã xong và không còn chặn GPU. **P1.5b T3 training là job GPU-ready hiện tại**;
...
2. **P1.5c FedProx-LoRA T3 evaluation**
   - Chờ: chạy và review P1.5b production training.
   - Chỉ eval endpoint T3; dùng kết quả registered cho centralized, pure FL và FedLS.
