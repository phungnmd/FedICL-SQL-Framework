...
| P1 | optimizer baseline | matched FedProx-LoRA (`mu=0.01`, client-only proximal loss, plaintext weighted FedAvg) | P1.5c completed on server and failed the operational promotion gate; awaiting pushed predictions for canonical paired closure |
