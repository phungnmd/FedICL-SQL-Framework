...
| P1 | optimizer baseline | matched FedProx-LoRA (`mu=0.01`, client-only proximal loss, plaintext weighted FedAvg) | implementation `897fb66`; fingerprints complete; 334 tests pass; P1.5a GPU smoke active before one T3 run |
