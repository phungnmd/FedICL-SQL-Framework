...
| P1 | optimizer baseline | matched FedProx-LoRA (`mu=0.01`, client-only proximal loss, plaintext weighted FedAvg) | implementation `897fb66`; P1.5a-R smoke passed; one seed-0 T3 production lineage active before endpoint evaluation |
