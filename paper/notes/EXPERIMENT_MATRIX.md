...
| P1 | optimizer baseline | matched FedProx-LoRA (`mu=0.01`, client-only proximal loss, plaintext weighted FedAvg) | T3 training complete at `d48f05b`; full-Spider T3 endpoint evaluation active |
