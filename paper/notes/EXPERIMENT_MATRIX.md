...
| P1 | stronger semantic-domain-skew sensitivity | fixed 8,659 rows and `K=5`; `alpha=0.1` FL vs FedLS T1 before any T3 extension | audit passed at `e97583d`: mean JSD `0.527→0.805`, entropy `3.029→2.183`; P1.3b training ready |
