...
| P0 | Does structured teacher KD beat gold training and survive terminal A? | same 1,000 teacher-admitted rows: source-gold CE vs teacher plan+SQL, before and after identical A | deferred until P2.9 decides; runbook in `archive/superseded_runbooks/P28_STRUCT_GOLD_GATE_DEFERRED_2026-09-24.md` |
