...
| P1 | optimizer baseline | matched FedProx-LoRA (`mu=0.01`, client-only proximal loss, plaintext weighted FedAvg) | closed negative: 62.77 vs pure-FL 64.31 EX; 22/38 paired gains/losses (`p=0.0519`); 194/193 errors |
