...
| P0.8b | Final T3 pure-FL versus frozen FedLS-SQL at seed 2 | **active GPU command below; final three-seed reliability gate** |
...
until resource evidence is reactivated. The current GPU priority is P0.8b.
...
## P0.8b — final T3 reliability at seed 2

**Purpose:** close the three-training-seed reliability result after seed 1
...
The preflight pins seed-2 setup identities (`8b02d882...` for pure FL and
