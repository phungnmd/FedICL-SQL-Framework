...
| P0.7a | Smoke Gemma 2B training, adapter load, and inference | **run next; stop if it fails** |
| P0.7b | Smoke Gemma 9B→2B targets, token-ID compatibility, and logit cache | gated by P0.7a |
