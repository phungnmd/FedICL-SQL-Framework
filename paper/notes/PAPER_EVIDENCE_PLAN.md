...
| GPU ready | 7 | P1.5b matched FedProx-LoRA T3 | P1.5a-R passed all five proximal/aggregation checks; run one matched seed-0 plaintext T3 lineage, then gate a T3-only Spider evaluation |
