# P2.5 — completed SeqKD versus KID runbook (2026-09-20)

Historical commands only. SeqKD and KID public/terminal endpoints were
completed and published; do not rerun these blocks as the active queue.
...
[Old K2 commands](P24C_CANCELLED_2026-09-17.md)
