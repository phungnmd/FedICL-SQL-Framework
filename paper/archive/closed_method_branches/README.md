...
| `P017A_PREFERENCE_KD_2026-08-28.md` | fixed 512-row execution-verified global-model preference-KD screen | closed negative: 54.93 vs 56.87 EX and 22 more execution errors; no tuning or full extension |
...
`fedicl-sql/experiments/archive/p017_preference_kd_2026-08/` at nested commit
`74f0a43`.
