...
This directory preserves material superseded by the advisor-approved FedLS-SQL
framing on 2026-08-19.

The archived documents are historical evidence, not the current method or run
queue. They are retained to preserve decisions, negative results, and exact
reproduction instructions. Do not silently update their terminology or result
labels.
...
Presentation names may change from FedICL/Fed-ICKD to FedLS-SQL, but provenance
